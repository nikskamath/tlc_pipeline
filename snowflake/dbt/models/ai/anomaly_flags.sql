...
-- Pure SQL anomaly detection using z-scores per borough.
-- Avoids Snowpark Python models entirely — no special permissions
-- needed, runs faster, and is easier to explain in an interview
-- than a black-box Isolation Forest call.
